...
"""
    Collects output from single sample featureCounts analysis, combines output from all samples into one report per output type (TPM/Raw).
    Input:  File with list of featureCounts output files. 
